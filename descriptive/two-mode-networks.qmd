...
The biadjacency matrix and can be obtained via `as_biadjacency_matrix()`. This matrix is shown in @fig-incmat and the network itself in @fig-southern-women-plot.
