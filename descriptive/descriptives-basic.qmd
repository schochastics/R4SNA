...
The adjacency matrix of the network can be obtained with the `as_adjacency_matrix()` function. 
```{r}
#| label: adjacency
...
nodes in a directed network (see @fig-triad-types). Triads are labeled using
