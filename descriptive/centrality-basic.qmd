...
A classic application of centrality analysis is the *Florentine Families* dataset, popularized in network analysis by @padgett1993robust, which records marriage ties among prominent Renaissance families in Florence. This network is included in the `networkdata` package.
...
The four indices land at different rank positions within each node's interval, which is the partial-ordering view of the disagreement we saw earlier in @fig-dbces11-centrality.
