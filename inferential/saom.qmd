...
triads. If actor $i$ sends a tie to $h$, and $h$ sends a tie to $j$, then $i$ is
more likely to send a tie to $j$.
...
Given that the overall maximum convergence ratio exceeds the recommended
threshold, the model has not fully converged. Therefore, the parameter estimates
should be interpreted with caution, as they may not reliably reflect the
