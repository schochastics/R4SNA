...
> Key point: here `smoking_beh` is no longer only a covariate. It is a
> **behavioral dependent variable**, so the model estimates both **selection**
> effects and **influence** effects.
...
In this model, although individual convergence t-ratios are all below 3.39, the
overall maximum convergence ratio is 28.47, which is far above acceptable
