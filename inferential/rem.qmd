...
Including contextual covariates allows relational event models to move beyond purely structural explanations of interaction sequences and to account for how social behaviour is shaped by situational or institutional conditions.
...
To identify potential outliers, we can locate events with particularly large residuals. For illustration, we define outlying cases as those with residuals greater than 12 ($\approx \text{Threshold} = Q_3 + 1.5 \times IQR)$. 
```{r}
