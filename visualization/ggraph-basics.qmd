...
We start with a simple plot without any styling.
```{r}
#| label: polblogs1
#| fig-width: 10
#| fig-height: 8
...
Let us now start with some styling of the nodes.
...
Now let us just add the `theme_graph()` to finalize the plot
```{r}
#| label: polblogs9
#| fig-width: 10
#| fig-height: 8
