...
The following example combines styled nodes and edges, interactive behaviors, and the plugins that add the most for graph exploration — tooltips, wealth-tier hulls, and a legend — into a single polished visualization (@fig-g6r-final).
...
g6(nodes, edges) |>
  ...
  g6_plugins(
    tooltips(getContent = tooltip_content),
    hull(
      key = "hull-low", members = tier_members$low,
      fill = palette3[["low"]], stroke = palette3[["low"]]
    ),
