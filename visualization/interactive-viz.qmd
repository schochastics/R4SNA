...
graphjs(flo,
  vertex.size = 0.3 + 0.1 * V(flo)$degree,
  vertex.color = palette3[V(flo)$wealth_tier]
)
```
...
nodes_bold <- do.call(g6_nodes, Map(
  function(name, tier, deg) {
    g6_node(
      id = name,
      data = list(wealth_tier = tier, degree = deg),
