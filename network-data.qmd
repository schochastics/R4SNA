...
Classical social theorists emphasized this relational foundation of social life. Georg Simmel argued that society exists where individuals enter into interaction [@simmel19081971]. Émile Durkheim described society as a system formed by associated individuals and their channels of communication [@durkheim1974individual]. Karl Marx similarly stressed that society does not consist of isolated individuals, but expresses the sum of interrelations within which individuals stand [@marx1993grundrisse]. These perspectives share a central insight: social structure is relational.
